...
class KeyboardEventWidgetState extends State<KeyboardEventWidget> with WidgetsBindingObserver {
  ...
  Duration checkEndDelay = const Duration(milliseconds: 150);
  ...
  void didChangeMetrics() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      // moving
      if (widget.onKbHiding!=null && isKbHiding && bottomMargin > newBottomMargin) {
        widget.onKbHiding!(newBottomMargin);
      }
      else if (widget.onKbShowing!=null && isKbShowing && bottomMargin < newBottomMargin) {
  ...
  void showBegin(double newBottomMargin) {
    ...
    Future.delayed(checkEndDelay+100, (){
