(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,31175,t=>{"use strict";var e=t.i(43476),a=t.i(15504),s=t.i(18566);function l(){let t=(0,a.useRef)(null),l=(0,s.usePathname)();return(0,a.useEffect)(()=>{if(!t.current)return;t.current.innerHTML="";let e=document.createElement("script");e.src="https://giscus.app/client.js",e.setAttribute("data-repo","koocyton/koocyton.github.io"),e.setAttribute("data-repo-id","MDEwOlJlcG9zaXRvcnkxNDY5NTUzMzQ="),e.setAttribute("data-category","Announcements"),e.setAttribute("data-category-id","DIC_kwDOCMJcRs4C225y"),e.setAttribute("data-mapping","pathname"),e.setAttribute("data-strict","0"),e.setAttribute("data-reactions-enabled","1"),e.setAttribute("data-emit-metadata","0"),e.setAttribute("data-input-position","top"),e.setAttribute("data-theme","light"),e.setAttribute("data-lang","zh-CN"),e.setAttribute("data-loading","lazy"),e.crossOrigin="anonymous",e.async=!0,t.current.appendChild(e)},[l]),(0,e.jsx)("div",{className:"mt-12 pt-6 border-t border-[var(--color-border)]",children:(0,e.jsx)("div",{ref:t})})}t.s(["default",()=>l])},5341,t=>{"use strict";var e=t.i(43476),a=t.i(15504);let s=`<div class="wrap">
  ...
  </div>`;function l(){return(0,a.useEffect)(()=>{let t=!1;window.__quanshengFlashToolsBooted=!1;let e="quansheng-flashtools-css";if(!document.getElementById(e)){let t=document.createElement("link");t.id=e,t.rel="stylesheet",t.href="/quansheng-flashtools/tool.css",document.head.appendChild(t)}let a="quansheng-flashtools-app-js",s=document.getElementById(a);s&&s.remove();let l=document.createElement("script");return l.id=a,l.src=`/quansheng-flashtools/app.js?v=${Date.now()}`,l.onload=()=>{t||window.bootQuanshengFlashTools?.()},l.onerror=()=>{t||console.error("[quansheng-flashtools] failed to load app.js")},document.body.appendChild(l),()=>{t=!0,window.__quanshengFlashToolsBooted=!1;let e=document.getElementById(a);e&&e.remove()}},[]),(0,e.jsx)("div",{className:"quansheng-flashtools-host",dangerouslySetInnerHTML:{__html:s}})}t.s(["default",()=>l])}]);